...
//class Dashboard extends React.Component {
  ...
  async function getDoughnuts() {
    const doughnuts = await api.getDoughnutsFromApi()
      ...
      <Aux>
        <Row>
          <Col md={6} xl={4}>
            <Card>
              <Card.Body>
                <h6 className="mb-4">فروش روزانه</h6>
                    ...
                    <tr className="unread">
                      ...
                      <td>
                        <a
                          ...
                          className="label theme-bg-red text-white f-12"
                        >
                          رد
                        </a>
                        <a
            ...
            <Card className="card-event">
              <Card.Body>
                ...
                <h2 className="mt-2 f-w-300">
                  45<sub className="text-muted f-14">رقبا</sub>
                </h2>
                <h6 className="text-muted mt-3 mb-0">
                  شما در این رویداد می توانید شریک بشوید{" "}
                </h6>
