...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.menu.preLayout,
        collapseMenu: state.menu.collapseMenu,
        layoutType: state.menu.layoutType,
        navBackColor: state.menu.navBackColor,
        navBackImage: state.menu.navBackImage,
        navIconColor: state.menu.navIconColor,
        navBrandColor: state.menu.navBrandColor,
        layout6Background: state.menu.layout6Background,
        layout6BackSize: state.menu.layout6BackSize,
        rtlLayout: state.menu.rtlLayout,
        navFixedLayout: state.menu.navFixedLayout,
        boxLayout: state.menu.boxLayout,
        navDropdownIcon: state.menu.navDropdownIcon,
        navListIcon: state.menu.navListIcon,
        navActiveListColor: state.menu.navActiveListColor,
        navListTitleColor: state.menu.navListTitleColor,
        navListTitleHide: state.menu.navListTitleHide
    }
};
